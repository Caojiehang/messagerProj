...
public class ChatHistoryDaoImpl implements ChatHistoryDao {
    ...
    /**
     * add new chat records to database
     * @param ChatHistory
     * @throws SQLException
     */
    @Override
    ...
    /**
     * find chat records from database by following three fields
     * @param sender
     * @param receiver
     * @param send_time
     * @return
     ...
     */
    @Override
    public List<PrivateChatHistory> find(String sender, String receiver, Date send_time) throws SQLException {
        Connection con = null;
        PreparedStatement pst = null;
        ResultSet set = null;
